...
![http://www.sthda.com/english/wiki/line-types-in-r-lty](images/linetypes.png){width=75%}
...
## Point types (pch)
![http://www.sthda.com/english/wiki/r-plot-pch-symbols-the-different-point-shapes-available-in-r](images/dottypes.png){width=50%}
